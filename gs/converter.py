...
__LATIN = (
    ["ïw", "ïa", "ïo", "uï", "üï", "wï", "yï", "eï", "eï", "aï", "äï", "oï", "öï", "a", "ä", "b", "v", "g", "ğ", "d", "e", "j", "z", "ï", "ï", "k", "q", "l", "m", "n", "ŋ", "o", "ö", "p", "r", "s", "t", "w", "u", "ü", "f", "h", "h", "c", "č", "š", "ş", "", "y", "i", "", "e"],
    ["ю", "я", "ё", "ұй", "үй", "уй", "ый", "ей", "эй", "ай", "әй", "ой", "өй", "а", "ә", "б", "в", "г", "ғ", "д", "е", "ж", "з", "и", "й", "к", "қ", "л", "м", "н", "ң", "о", "ө", "п", "р", "с", "т", "у", "ұ", "ү", "ф", "х", "һ", "ц", "ч", "ш", "щ", "", "ы", "і", "", "э"],
)
__TOTE = (
